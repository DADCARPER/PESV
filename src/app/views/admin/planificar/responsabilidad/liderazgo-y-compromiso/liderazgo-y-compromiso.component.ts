...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, LoadingComponent, FormsModule, ReactiveFormsModule, CardsBotonComponent, PasopasoComponent, PdfLiderazgoCompromisoComponent, UploadArchivosComponent],
