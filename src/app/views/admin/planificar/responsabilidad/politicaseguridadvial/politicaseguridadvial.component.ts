...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, CardsBotonComponent, FormsModule, ReactiveFormsModule, PasopasoComponent, UploadArchivosComponent, PdfPoliticasSeguridadVialComponent, LoadingComponent],
