...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, PdfComiteSeguridadVialComponent, CardsBotonComponent, PasopasoComponent, ProgressCircleComponent, ModalsGuiaComponent, UploadArchivosComponent, LoadingComponent],
